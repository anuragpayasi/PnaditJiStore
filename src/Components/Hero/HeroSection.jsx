...
const HeroSection = () => {
    return (
        <section id='Home' className='relative flex flex-col lg:flex-row min-h-screen w-full overflow-hidden bg-gradient-to-b from-gray-300 to-amber-200 sm:pt-0 pb-8 px-10'>
